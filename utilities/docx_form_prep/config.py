"""Paths are relative to the repository root when running the CLI from that root."""

_REPO_REL = "backend/src/main/resources/templates/documents"

# Longer / composite placeholders first within each job (overlap with shorter tokens).
