...
const DETAIL_EXACT: Record<string, string> = {
  ...
  'Trip must be pending approval': 'Рейс должен быть в статусе «На согласовании»',
  'Trip must be approved': 'Рейс должен быть утверждён',
  'Trip is locked': 'Рейс заблокирован для изменений',
